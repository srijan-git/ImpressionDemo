...
<body>
    ...
    <div class="cinematicvideoBox">
        <h2 class="text-center p-5 mb-5 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">CINEMATIC PORTRAIT VIDEO</h2>
        <section id="video" class="bg-light">
            <div class="row p-3">
                <div class="col-xs-6 col-md-6 p-3">
